...
export const TOOL_LANDINGS: ToolLandingEntry[] = [
  ...
  },
  {
    ...
    related: [
      { label: "Merge PDF", href: "/pdf/merge/" },
      { label: "Reorder PDF", href: "/pdf/reorder/" },
      { label: "All PDF tools", href: "/pdf/" },
    ],
  },
  {
  ...
  },
  {
    ...
    related: [
      { label: "Convert image", href: "/image/convert/" },
  ...
  },
  {
    ...
    parentPath: "/convert/",
    parentLabel: "File converter",
    crumb: "Markdown to HTML",
    iframeSrc: "/convert/?tool=md2html&embed=1",
    widgetTitle: "Convert Markdown to a standalone HTML page",
    title: "Markdown to HTML Converter Online Free — No Upload",
    description: "Turn Markdown into a standalone HTML page for free, in your browser. Paste, preview and download — nothing is uploaded.",
    h1: "Convert Markdown to HTML",
    lead: "Paste Markdown, preview it as rendered HTML and download a standalone page. Conversion runs locally in your browser.",
    note: "100% local conversion: the HTML is generated on your device; nothing is uploaded.",
    howtoHeading: "How to convert Markdown to HTML",
    steps: [
      { title: "Paste the Markdown", text: "Type or paste the source text into the editor." },
      { title: "Preview", text: "The rendered HTML preview updates as you type." },
      { title: "Download", text: "Save a standalone HTML page that needs no external scripts." },
    ],
    faqs: [
      { q: "Is my text uploaded?", a: "No. Markdown is parsed locally in your browser." },
      { q: "What Markdown is supported?", a: "Common Markdown plus tables, code blocks and links; the page uses the Marked library locally." },
    ],
    featureList: ["Live HTML preview", "Standalone download", "Processed locally, never uploaded", "Free, no sign-up"],
    related: [
      { label: "Markdown to PDF", href: "/convert/markdown-to-pdf/" },
      { label: "PDF to text", href: "/convert/pdf-to-text/" },
  ...
  },
  {
    ...
    parentPath: "/convert/",
    parentLabel: "File converter",
    crumb: "Markdown to PDF",
    iframeSrc: "/convert/?tool=m2p&embed=1",
    widgetTitle: "Convert Markdown or HTML to a PDF",
    title: "Markdown to PDF Converter Online Free — No Upload",
    description: "Turn Markdown or HTML into a clean PDF for free, in your browser. Conversion happens locally — nothing is uploaded.",
    h1: "Convert Markdown or HTML to PDF",
    lead: "Paste Markdown or HTML and get a clean PDF with wrapped text and pagination. All conversion runs locally in your browser.",
    note: "100% local conversion: the PDF is generated on your device with pdf-lib; nothing is uploaded.",
    howtoHeading: "How to convert Markdown to PDF",
    steps: [
      { title: "Paste the source", text: "Type or paste Markdown (or HTML) into the editor." },
      { title: "Convert", text: "Press the button — text is measured and pages are added automatically." },
      { title: "Download", text: "Save the generated PDF from your browser." },
    ],
    faqs: [
      { q: "Is my text uploaded?", a: "No. The PDF is drawn locally in your browser." },
      { q: "Can I use HTML as input?", a: "Yes — HTML is stripped to its text content before being typeset into the PDF." },
    ],
    featureList: ["Markdown or HTML input", "Automatic pagination", "Processed locally, never uploaded", "Free, no sign-up"],
    related: [
      { label: "Markdown to HTML", href: "/convert/markdown-to-html/" },
      { label: "PDF to text", href: "/convert/pdf-to-text/" },
      { label: "All converters", href: "/convert/" },
    ],
  },
  {
    ...
    parentLabel: "File converter",
    crumb: "PDF to Text",
    iframeSrc: "/convert/?tool=pdf2txt&embed=1",
    widgetTitle: "Extract text from a PDF as a TXT file",
    title: "PDF to Text Converter Online Free — Extract TXT, No Upload",
    description: "Extract the text layer of a PDF and download it as a TXT file, for free and in your browser. Files never leave your device.",
    h1: "Convert PDF to plain text",
    lead: "Pull the selectable text out of a PDF and save it as a .txt file. Extraction runs locally in your browser.",
    note: "100% local conversion: the text is read on your device; nothing is uploaded.",
    howtoHeading: "How to convert a PDF to text",
    steps: [
      { title: "Choose the PDF", text: "Pick the file or drop it onto the box." },
      { title: "Extract", text: "Press the button to read the document's text layer." },
      { title: "Copy or download", text: "Copy the result or save it as a TXT file." },
    ],
    faqs: [
      { q: "My PDF has no extractable text — why?", a: "Scanned pages are images without a text layer; OCR is needed first." },
      { q: "Is my PDF uploaded?", a: "No. Extraction happens locally in your browser." },
    ],
    featureList: ["Copy or TXT download", "Runs fully in the browser", "Free, no sign-up"],
    related: [
      { label: "Markdown to PDF", href: "/convert/markdown-to-pdf/" },
      { label: "Extract archive", href: "/convert/extract-archive/" },
      { label: "All converters", href: "/convert/" },
    ],
  },
  {
    ...
    iframeSrc: "/convert/?tool=img2&embed=1",
    widgetTitle: "Batch-convert images and download a ZIP",
    title: "Batch Image Converter Online Free — PNG, JPEG, WebP, SVG, No Upload",
    description: "Re-encode several images at once and download them as one ZIP, for free and in your browser. Files are never uploaded.",
    h1: "Convert several images at once",
    lead: "Re-encode a folder of images into one format — SVG rasterizing included — and download a single ZIP. All processing is local.",
    note: "100% local conversion: images are processed in your browser and packed into a ZIP on your device.",
    howtoHeading: "How to batch convert images",
    steps: [
      { title: "Choose the images", text: "Pick several files or drop a folder." },
      { title: "Pick the output format", text: "Choose PNG, JPEG or WebP; SVG inputs are rasterized." },
      { title: "Download the ZIP", text: "Press the button and the archive is saved by your browser." },
    ],
    faqs: [
      { q: "Are my images uploaded?", a: "No. Conversion and ZIP creation run entirely in your browser." },
      { q: "Can SVG be converted?", a: "Yes — SVG files are rasterized, so SVG to PNG works too." },
    ],
    featureList: ["Multiple files in one pass", "SVG rasterizing", "ZIP output built locally", "Free, no sign-up"],
    related: [
      { label: "Create archive", href: "/convert/create-archive/" },
      { label: "All converters", href: "/convert/" },
      { label: "Image tools", href: "/image/" },
    ],
  },
  {
    ...
    parentLabel: "File converter",
    crumb: "JSON to CSV",
    iframeSrc: "/convert/?tool=jsoncsv&embed=1",
    widgetTitle: "Convert JSON to CSV or CSV to JSON",
    title: "JSON to CSV Converter Online Free — No Upload",
    description: "Convert JSON to CSV or CSV back to JSON for free, in your browser. Paste your data and download the result — nothing is uploaded.",
    h1: "Convert JSON to CSV",
    lead: "Turn an array of objects into a clean CSV table (or parse a CSV back into JSON) — instantly, locally in your browser.",
    note: "100% local conversion: your data is parsed on your device; nothing is uploaded.",
    howtoHeading: "How to convert JSON to CSV",
    steps: [
      { title: "Paste the JSON", text: "Paste an array of flat objects or an object of arrays into the input." },
      { title: "Convert", text: "Press the button — rows are aligned by index and fields become columns." },
      { title: "Copy or download", text: "Copy the CSV or download it as a file." },
    ],
    faqs: [
      { q: "Can I convert CSV back to JSON?", a: "Yes — the tool works in both directions and swaps the input and output for you." },
      { q: "Is my data uploaded?", a: "No. Conversion happens locally in your browser." },
    ],
    featureList: ["JSON to CSV and CSV to JSON", "Handles object-of-arrays input", "Processed locally, never uploaded", "Free, no sign-up"],
    related: [
      { label: "JSON to YAML", href: "/convert/json-to-yaml/" },
      { label: "XML to JSON", href: "/convert/xml-to-json/" },
      { label: "All converters", href: "/convert/" },
    ],
  },
  {
    ...
    parentLabel: "File converter",
    crumb: "JSON to YAML",
    iframeSrc: "/convert/?tool=yamljson&embed=1",
    widgetTitle: "Convert JSON to YAML or YAML to JSON",
    title: "JSON to YAML Converter Online Free — No Upload",
    description: "Convert JSON to YAML or YAML back to JSON for free, in your browser. Paste, convert and download — data never leaves your device.",
    h1: "Convert JSON to YAML",
    lead: "Switch configuration files between JSON and YAML with one click — parsed locally in your browser.",
    note: "100% local conversion: your data is processed on your device; nothing is uploaded.",
    howtoHeading: "How to convert JSON to YAML",
    steps: [
      { title: "Paste the data", text: "Paste JSON (or YAML) into the input." },
      { title: "Convert", text: "Press the button to get YAML (or JSON) in the output." },
      { title: "Copy or download", text: "Copy the result or download it as a file." },
    ],
    faqs: [
      { q: "Which format is best?", a: "YAML is friendlier for config files with comments; JSON is easier for machines. The tool converts both ways." },
      { q: "Is my data uploaded?", a: "No. Parsing happens locally in your browser." },
    ],
    featureList: ["JSON to YAML and back", "Preserves structure", "Processed locally, never uploaded", "Free, no sign-up"],
    related: [
      { label: "JSON to CSV", href: "/convert/json-to-csv/" },
      { label: "All converters", href: "/convert/" },
      { label: "Secret Sender", href: "/secret/" },
    ],
  },
  {
    ...
    parentLabel: "File converter",
    crumb: "XML to JSON",
    iframeSrc: "/convert/?tool=xml2json&embed=1",
    widgetTitle: "Convert XML to JSON",
    title: "XML to JSON Converter Online Free — No Upload",
    description: "Convert XML documents to JSON for free, in your browser. Paste your XML and download the result — nothing is uploaded.",
    h1: "Convert XML to JSON",
    lead: "Turn an XML document into JSON, keeping the structure readable. The conversion runs locally in your browser.",
    note: "100% local conversion: your XML is parsed on your device; nothing is uploaded.",
    howtoHeading: "How to convert XML to JSON",
    steps: [
      { title: "Paste the XML", text: "Paste or type the XML document into the input." },
      { title: "Convert", text: "Press the button and the JSON appears in the output." },
      { title: "Copy or download", text: "Copy the JSON or download it as a file." },
    ],
    faqs: [
      { q: "Is my XML uploaded?", a: "No. Conversion happens locally in your browser." },
      { q: "What about attributes?", a: "Elements and their structure are preserved in the JSON output so the document stays readable." },
    ],
    featureList: ["Element and attribute mapping", "Instant output", "Processed locally, never uploaded", "Free, no sign-up"],
    related: [
      { label: "JSON to CSV", href: "/convert/json-to-csv/" },
      { label: "All converters", href: "/convert/" },
  ...
  },
  {
    ...
    parentPath: "/convert/",
    parentLabel: "File converter",
    crumb: "Create Archive",
    iframeSrc: "/convert/?tool=mkzip&embed=1",
    widgetTitle: "Create a ZIP, TAR or GZIP archive",
    title: "Create ZIP, TAR or GZIP Online Free — No Upload",
    description: "Pack files into a ZIP or TAR archive, or gzip a single file, for free and in your browser. Files are never uploaded.",
    h1: "Create a ZIP, TAR or GZIP archive",
    lead: "Compress one or many files into a standard archive without installing software. Everything happens locally in your browser.",
    note: "100% local processing: archives are built on your device; nothing is uploaded.",
    howtoHeading: "How to create an archive",
    steps: [
      { title: "Choose the files", text: "Pick the files or folders to pack." },
      { title: "Pick the format", text: "Choose ZIP or TAR for multiple files, or GZIP for a single file." },
      { title: "Download", text: "Press the button and the archive is saved by your browser." },
    ],
    faqs: [
      { q: "Are my files uploaded?", a: "No. The archive is assembled locally in your browser." },
      { q: "Which format should I choose?", a: "ZIP is the most compatible; TAR preserves Unix permissions; GZIP compresses a single file." },
    ],
    featureList: ["ZIP, TAR and GZIP output", "Built locally with fflate", "Free, no sign-up"],
    related: [
      { label: "Extract archive", href: "/convert/extract-archive/" },
      { label: "Batch image converter", href: "/convert/convert-images/" },
      { label: "All converters", href: "/convert/" },
    ],
  },
  {
    ...
    parentPath: "/convert/",
    parentLabel: "File converter",
    crumb: "Extract Archive",
    iframeSrc: "/convert/?tool=unpack&embed=1",
    widgetTitle: "Extract files from a ZIP or TAR archive",
    title: "Extract ZIP or TAR Online Free — No Upload",
    description: "Open ZIP and TAR archives and download individual files, for free and in your browser. Files never leave your device.",
    h1: "Extract files from an archive",
    lead: "Browse the contents of a ZIP or TAR archive and download what you need — unpacked locally in your browser.",
    note: "100% local processing: archives are read on your device; nothing is uploaded.",
    howtoHeading: "How to extract an archive",
    steps: [
      { title: "Choose the archive", text: "Pick the ZIP or TAR file or drop it onto the box." },
      { title: "Browse the contents", text: "Entries are listed with their sizes; download anything you need." },
      { title: "Download", text: "Save individual files from the archive." },
    ],
    faqs: [
      { q: "Is my archive uploaded?", a: "No. Extraction happens locally in your browser." },
      { q: "Which formats are supported?", a: "ZIP and TAR archives; individual entries can be downloaded directly." },
    ],
    featureList: ["ZIP and TAR input", "Per-entry download", "Processed locally, never uploaded", "Free, no sign-up"],
    related: [
      { label: "Create archive", href: "/convert/create-archive/" },
      { label: "PDF to text", href: "/convert/pdf-to-text/" },
      { label: "All converters", href: "/convert/" },
